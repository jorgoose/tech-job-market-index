...
Interactive visualization comparing **software development job postings** (via the FRED/Indeed index) with **undergraduate CS enrollment** at the top 20 US universities.
...
- **Job Postings**: [FRED IHLIDXUSTPSOFTDEVE](https://fred.stlouisfed.org/series/IHLIDXUSTPSOFTDEVE) — Indeed Software Development Job Postings Index (Feb 2020 = 100, seasonally adjusted)
